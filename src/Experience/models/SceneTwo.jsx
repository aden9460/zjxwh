...
export default function Model(props) {
  const { nodes, materials } = useGLTF(assetUrl("models/scene_2.glb"));

  const scene_2 = useKTX2Texture(assetUrl("textures/scene_2.ktx2"));
...
useGLTF.preload(assetUrl("models/scene_2.glb"));
