...
export default function Model({ scrollProgress, ...props }) {
  const { nodes, materials } = useGLTF(assetUrl("models/scene_3.glb"));
  ...
  const scene_3 = useKTX2Texture(assetUrl("textures/scene_3.ktx2"));
...
useGLTF.preload(assetUrl("models/scene_3.glb"));
