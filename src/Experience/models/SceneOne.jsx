...
export default function Model(props) {
  const { nodes, materials } = useGLTF(assetUrl("models/scene_1.glb"));
  ...
  const waterfallone = useKTX2Texture(assetUrl("textures/waterfall_one.ktx2"));
  const waterfalltwo = useKTX2Texture(assetUrl("textures/waterfall_two.ktx2"));
  const not_waterfall = useKTX2Texture(
    assetUrl("textures/not_waterfall.ktx2"),
    true,
    0.6,
    "double"
  );
  const scene_1_bg = useKTX2Texture(assetUrl("textures/scene_1_bg.ktx2"));
  const scene_1 = useKTX2Texture(assetUrl("textures/scene_1.ktx2"));
...
useGLTF.preload(assetUrl("models/scene_1.glb"));
