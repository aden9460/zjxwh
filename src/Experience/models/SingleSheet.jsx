...
export default function Model({ scrollProgress, ...props }) {
  ...
  const singlesheet = useKTX2Texture(assetUrl("textures/single_sheet.ktx2"));
  const kpop = useKTX2Texture(assetUrl("textures/kpop.ktx2"));
...
useGLTF.preload(assetUrl("models/single_sheet.glb"));
