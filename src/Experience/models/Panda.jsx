...
export default function Model({ scrollProgress, cameraScrollCurve, ...props }) {
  const { nodes, materials } = useGLTF(assetUrl("models/Panda.glb"));
  const regular = useKTX2Texture(assetUrl("textures/regular.ktx2"));
  const samurai = useKTX2Texture(assetUrl("textures/samurai.ktx2"));
  const pirate = useKTX2Texture(assetUrl("textures/pirate.ktx2"));
  const desert = useKTX2Texture(assetUrl("textures/desert.ktx2"));
  const zombie = useKTX2Texture(assetUrl("textures/zombie.ktx2"));
...
useGLTF.preload(assetUrl("models/Panda.glb"));
