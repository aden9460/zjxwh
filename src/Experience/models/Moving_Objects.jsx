...
export default function Model({ scrollProgress, ...props }) {
  const { nodes, materials } = useGLTF(assetUrl("models/Moving_Extras.glb"));

  const material = useKTX2Texture(assetUrl("textures/Moving_extras.ktx2"));
  const dirtMaterial = useKTX2Texture(assetUrl("textures/dirt.ktx2"));
...
useGLTF.preload(assetUrl("models/Moving_Extras.glb"));
